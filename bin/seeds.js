...
let plants = [
  ...
  },
  {
    ...
    description: "Philodendrons may be grown in soil or just in water. Plants that live in soil should be watered when half of the soil is dry. As with most plants, yellow leaves indicate over-watering and brown leaves indicate under-watering. You can tell when a philodendron needs water because its leaves will appear wilted. When watered, the plant will reward you with a perky appearance.",
  },
  {
    name: "Peace Lily",
    waterFrequencyInDays: 4,
